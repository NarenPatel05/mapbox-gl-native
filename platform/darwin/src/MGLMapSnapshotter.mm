...
+ (NS_ARRAY_OF(MGLAttributionInfo *)*)generateAttributionInfos:(mbgl::MapSnapshotter::Attributions)attributions {
...
+ (void)drawAttributionTextWithStyle:(MGLAttributionInfoStyle)attributionInfoStyle origin:(CGPoint)origin attributionInfo:(NS_ARRAY_OF(MGLAttributionInfo *)*)attributionInfo
{
...
+ (CGSize)attributionSizeWithLogoStyle:(MGLAttributionInfoStyle)logoStyle sourceAttributionStyle:(MGLAttributionInfoStyle)attributionStyle attributionInfo:(NS_ARRAY_OF(MGLAttributionInfo *)*)attributionInfo
{
...
+ (CGSize)attributionTextSizeWithStyle:(MGLAttributionInfoStyle)attributionStyle attributionInfo:(NS_ARRAY_OF(MGLAttributionInfo *)*)attributionInfo
{
